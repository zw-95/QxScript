...
[rewrite_local]
^https:\/\/wemp\.issks\.com\/charge\/v1\/popup\/chargingSuccessPop url script-response-body https://raw.githubusercontent.com/zw-95/QxScript/master/MyScripts/shankailaidian/RemoveAds.js
...
if(body){
  // 去除
  if (url.includes("/charge/v1/popup/chargingSuccessPop/")) {
    if (body.data) {
      body.data.adopen = 0;
